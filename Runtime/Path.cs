...
namespace Nebukam.Splines
{
    ...
    /// <summary>
    /// Non-managed version of the ManagedPath class, using float3 instead of ManagedPoints
    /// </summary>
    public class Path
    {
        ...
        /// <param name="index"></param>
        /// <returns></returns>
        public float3 RemoveAt(int index)
        {
            float3 result = m_vertices[index];
        ...
        /// <summary>
        /// Return the point index in path of the nearest float3 to a given point
        /// </summary>
        /// <param name="v"></param>
        /// <returns></returns>
        public int GetNearestPointIndex(float3 v)
        {
        ...
        /// <summary>
        /// Return the the nearest float3 in path to a given float3 point
        /// </summary>
        /// <param name="v"></param>
        /// <returns></returns>
